...
public class ProfilPage extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnDateNaisProfil.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				...
				Log.i("dateN_click",btnDateNaisProfil.getText().toString());
			}
		});
		...
		btnEditCountProfil.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				...
				try {
					...
					inputDate = fmt.parse(btnDateNaisProfil.getText().toString());
				} catch (ParseException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				...
				Date inputDatePermis = null;
				try {
					inputDatePermis = fmtt.parse(btnDatePermProfil.getText().toString());
				} catch (ParseException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
	...
	class AddUser extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			pDialog.setMessage("Modifications en cours ...");
